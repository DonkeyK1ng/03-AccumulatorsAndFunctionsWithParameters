...
def draw_circles1():
    ...
    blue=rg.Pen.color='red'
    for k in range (21):
        circlen=rg.Circle(rg.Point(200,200),k*10)
...
def draw_circles2():
    ...
    for k in range(17):
        total = total +20
        pen=rg.Circle(rg.Point(total,100),10)
        pen.fill_color='blue'
...
def draw_circles3():
    ...
    for k in range(100):
        ...
        pen=rg.Circle(rg.Point(200,150),total)
        pen.attach_to(window);
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    another=0
    for k in range(100):
        total=200+(math.cos(k))*80
        another=200+(math.sin(k))*80
        pen=rg.Circle(rg.Point(total,another),10)
        pen.attach_to(window);
    window.render()
    window.close_on_mouse_click()
